...
1. **Install a Userscript Manager:**
   ...
   - [Violentmonkey](https://violentmonkey.top/) (Open Source)

2. **Install the Script:**
   - Click the `Raw` button of the `.user.js` file in this repository.
   - Or create a new script in your manager and paste the code from `Upwork Insight - Unified.user.js`.
...
Randomized Delays: The script will never fetch data instantly. It waits a random interval (default: 2–4 seconds) between requests to mimic human browsing speed.

On-Demand fetching: By default, "Search" results do not auto-fetch. You must click the "Insight" button manually, which keeps your traffic organic.

Cloudflare Detection: If Upwork presents a "Verify you are human" challenge, the script detects the specific 403/503 error headers, pauses all activity, and prompts you to verify manually.
